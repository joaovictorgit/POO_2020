...
public class Matricula {
    ...
    public static void main(String[] args) {
        ...
        Aluno alu1 = new Aluno("pedro");
        Disciplina d1 = new Disciplina("fup");
        Disciplina d2 = new Disciplina("calculo");
        Disciplina d3 = new Disciplina("discreta");
        
        mat.addAluno("carlos");
        mat.addAluno("pedro");
        mat.addDisc("fup");
        mat.addDisc("discreta");
        mat.vincular("carlos", "fup");
        mat.vincular("pedro", "discreta");
        mat.show();
        mat.desmatricular("carlos", "fup");
        mat.show();
        mat.remove("carlos");
        mat.show();*/
